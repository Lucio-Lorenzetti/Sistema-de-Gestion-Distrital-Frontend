        ...
        <div className="min-h-screen bg-scout-bg-panel font-sans pb-20">
            <header className="bg-scout-bg-card border-b border-scout-border py-12 px-6 md:px-20">
                <div className="max-w-5xl mx-auto w-full">
                    <h1 className="text-3xl md:text-5xl font-black uppercase tracking-tighter text-scout-ink">
                        Galería de <span className="text-scout-primary italic">Eventos</span>
                    </h1>
                </div>
            </header>
                    ...
                    {ALBUMES.map(album => (
                        <a key={album.id} href={album.link} target="_blank" rel="noopener noreferrer"
                            ...
                            <div className="p-8 flex justify-between items-center">
                                <h2 className="font-bold uppercase tracking-tight text-sm text-scout-ink">{album.titulo}</h2>
