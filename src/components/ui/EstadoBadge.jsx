...
const ESTADO_STYLES = {
    ...
    Programada: 'bg-scout-primary/10 text-scout-primary border border-scout-primary/20',
    Enviado: 'bg-scout-success text-white',
    Rechazado: 'bg-scout-accent-light text-scout-accent border border-scout-accent/20',
};
